...
# include=FALSE : unable to supress JGmisc::cohens.d output
...
period1.mean <- period1.stats$m1
period2.mean <- period2.stats$m1
period3.mean <- period3.stats$m1
...
knitr::kable(stats.tbl, caption="Comparison of SNH and control weekly daytime trapped\ncrab spider counts (Wilcoxon signed-rank test)",
             col.names = c("seasonal period", "Cohen's d effect size", "SNH transect mean spiders per week", "control transect mean spiders per week"),
             align = "lccc")
...
knitr::kable(stats.tbl, caption="power analysis by seasonal period: two sample t test",
             col.names = c("seasonal period", "Cohen's d effect size (calculated)", "alpha (proposed)", "power (calculated)", 
                           "actual sample size"),
             align = "lcccc")
...
knitr::kable(stats.tbl, caption="Comparison of SNH and control weekly daytime trapped\nspider counts by seasonal period (Wilcoxon signed-rank test)",
             col.names = c("seasonal period", "p value", "effect metric", "effect magnitude"),
             align = "lccc")
...
hypotheticalPopulation <- c(period1.mean, period2.mean, period3.mean)
