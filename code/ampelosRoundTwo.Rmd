...
```{r cohensFile, tab.cap = NULL, echo=FALSE, include=TRUE, message=F, warning=T}
...
```{r cohensGit, echo=FALSE, include=TRUE, results='asis', message=F, warning=T}
...
```{r powerStats, echo=FALSE, include=TRUE, results='asis', message=F, warning=T}
...
```{r test, echo=FALSE, include=TRUE, results='asis', message=F, warning=T, tab.cap = NULL}
