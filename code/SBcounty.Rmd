...
ampelosZoom <- ggmap(sq_map) + 
  ...
  labs(title="Ampelos Vineyards\n(Sta. Rita Hills AVA)",
          x="longitude", 
          y="latitude", 
          caption = paste("https://en.wikipedia.org/wiki/Sta._Rita_Hills_AVA", sep="") ) +
...
ampelos17 <- ggmap(sq_map) + 
  ...
  labs(title="Ampelos North Block",
          x="longitude", 
          y="latitude", 
          caption = paste(" ", sep="") ) +
...
if (TRUE) {
  ...
  ampelos.panel <- plot_grid(ampelos17, t.grobList[[1]],
            labels = c("figure A\nAmpelos North Block", 
                       "figure B\ntransect orientation"), # ascii backspace / <CR> does not work
            label_size=12, 
            label_fontface = "plain",
            axis="t",
            align = "v",
            ncol = 2,
            #rel_heights = c(1,1),      # applies to rows
            rel_widths = c(1,1.175),    # applies to columns
            scale = c(1, 1)
          )
  ...
  cowplot::save_plot("./output/ampelos.panel.jpg", ampelos.panel)
