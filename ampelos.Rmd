...
rl <- returnList
    ...
    # CAUTION: see populationAdjustmentFactor in generateLikelihoodV2()
    
    gg.likelihood.pm.list <- generateLikelihoodV2(df=filtered.df, inboundList=rl, daytime='pm', fromDisc=TRUE, path= ggsave.path)
